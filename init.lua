...
-- My Custom Keymaps
vim.keymap.set('n', '<S-l>', '<cmd>bn<cr>', { silent = true, desc = 'Next buffer' })
vim.keymap.set('n', '<S-h>', '<cmd>bp<cr>', { silent = true, desc = 'Previous buffer' })
vim.keymap.set('n', '<S-u>', '<cmd>bd<cr>', { silent = true, desc = 'Delete buffer' })
